	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 740);
    setWindowTitle(tr("Crew") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Crew address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&Crew Website"), this);
	pioAction->setToolTip(tr("Visit the Official Crew website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Crew discussion thread"));
	twitterAction = new QAction(QIcon(":/icons/twitter"), tr("&@Crew"), this);
	twitterAction->setToolTip(tr("Visit the Official Crew Twitter"));	
	chainAction = new QAction(QIcon(":/icons/explorer"), tr("&Crew Slack"), this);
	chainAction->setToolTip(tr("Join Crew Slack"));	
	githubAction = new QAction(QIcon(":/icons/github"), tr("&Github"), this);
	githubAction->setToolTip(tr("Visit the Official Crew Github"));	
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Crew"), this);
    aboutAction->setToolTip(tr("Show information about Crew"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Crew"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Crew top-logo"));
	...
	QToolBar *toolbar4 = addToolBar(tr("Crew side-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Crew client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Crew client"));
...
{
    QDesktopServices::openUrl(QUrl("http://www.crew.net"));
}
...
{
    QDesktopServices::openUrl(QUrl("https://twitter.com/crew"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("http://crew1.herokuapp.com"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Crew network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        if (strStatusBarWarnings.isEmpty())
        {
            ...
            progressBarLabel->setVisible(false);
            progressBar->setFormat(tr("Synchronizing with the Crew network:   %n block(s) remaining", "", nRemainingBlocks));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Crew address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStyle()
{
    ...
    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Crew.qss";
