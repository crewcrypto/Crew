    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the Crew network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the Crew network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CREW")
    updateDisplayUnit();
}
