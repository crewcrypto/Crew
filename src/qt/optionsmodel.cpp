...
void OptionsModel::Init()
{
    ...
    fUseCrewTheme = settings.value("fUseCrewTheme", true).toBool();
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseCrewTheme:
            fUseCrewTheme = value.toBool();
            settings.setValue("fUseCrewTheme", fUseCrewTheme);
            break;
        default:
            break;
        }
